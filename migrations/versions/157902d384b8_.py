...
Revision ID: 157902d384b8
Revises: 
Create Date: 2020-03-25 18:07:36.318008
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['kreoh_user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['domain'], ['kreoh_user.domain'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['kreoh_user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('domain'),
