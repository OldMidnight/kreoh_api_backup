...
#     assert os.path.exists(app.config['UPLOAD_FOLDER'] + 'fareed.kreoh.com.png') is True
...
#     assert os.path.exists(app.config['UPLOAD_FOLDER'] + 'fareedx.kreoh.com.png') is False
